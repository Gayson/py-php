...
interface CalculatorIf extends \shared\SharedServiceIf {
  ...
  /**
   * @param int $logid
   * @param \DataService\Work $w
   * @return int
   * @throws \DataService\InvalidOperation
   */
...
class Calculator_calculate_result {
  ...
  public $success = null;
  /**
   * @var \DataService\InvalidOperation
   */
  public $ouch = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        1 => array(
          'var' => 'ouch',
          'type' => TType::STRUCT,
          'class' => '\DataService\InvalidOperation',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->ouch = new \DataService\InvalidOperation();
...
class Calculator_works_args {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Calculator_works_args');
    $xfer += $output->writeFieldStop();
    $xfer += $output->writeStructEnd();
    return $xfer;
  }
...
class Calculator_works_result {
  ...
  public function getName() {
    return 'Calculator_works_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Calculator_works_result');
    if ($this->success !== null) {
