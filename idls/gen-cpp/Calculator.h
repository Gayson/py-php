...
public:
     ...
     */
    virtual void zip() = 0;
    virtual void works(std::vector<Work> & _return) = 0;
};
...
public:
    ...
    void works(std::vector<Work> & /* _return */) {
        return;
    }
};
...
class Calculator_works_args {
public:

    Calculator_works_args(const Calculator_works_args&);
    Calculator_works_args& operator=(const Calculator_works_args&);
    Calculator_works_args() {
    }

    virtual ~Calculator_works_args() throw();

    bool operator == (const Calculator_works_args & /* rhs */) const {
        return true;
    }
    bool operator != (const Calculator_works_args &rhs) const {
        return !(*this == rhs);
    ...
    bool operator < (const Calculator_works_args & ) const;
...
class Calculator_works_pargs {
public:


    virtual ~Calculator_works_pargs() throw();

    uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

};

typedef struct _Calculator_works_result__isset {
    _Calculator_works_result__isset() : success(false) {}
    bool success : 1;
} _Calculator_works_result__isset;

class Calculator_works_result {
public:

    Calculator_works_result(const Calculator_works_result&);
    Calculator_works_result& operator=(const Calculator_works_result&);
    Calculator_works_result() {
    }

    virtual ~Calculator_works_result() throw();
    std::vector<Work>  success;

    _Calculator_works_result__isset __isset;

    void __set_success(const std::vector<Work> & val);

    bool operator == (const Calculator_works_result & rhs) const {
        if (!(success == rhs.success))
            return false;
        return true;
    }
    ...
    bool operator < (const Calculator_works_result & ) const;
...
typedef struct _Calculator_works_presult__isset {
    _Calculator_works_presult__isset() : success(false) {}
    bool success : 1;
} _Calculator_works_presult__isset;

class Calculator_works_presult {
public:


    virtual ~Calculator_works_presult() throw();
    std::vector<Work> * success;

    _Calculator_works_presult__isset __isset;
...
public:
    ...
    void works(std::vector<Work> & _return);
    void send_works();
    void recv_works(std::vector<Work> & _return);
};
...
private:
    ...
    void process_works(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
public:
    CalculatorProcessor(boost::shared_ptr<CalculatorIf> iface) :
        ...
        processMap_["works"] = &CalculatorProcessor::process_works;
    }
...
public:
    ...
    void works(std::vector<Work> & _return);
    int32_t send_works();
    void recv_works(std::vector<Work> & _return, const int32_t seqid);
};
