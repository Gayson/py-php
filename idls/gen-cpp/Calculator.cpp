...
Calculator_works_args::~Calculator_works_args() throw() {
}


uint32_t Calculator_works_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Calculator_works_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
    uint32_t xfer = 0;
    apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
    xfer += oprot->writeStructBegin("Calculator_works_args");
...
Calculator_works_pargs::~Calculator_works_pargs() throw() {
}


uint32_t Calculator_works_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
    uint32_t xfer = 0;
    apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
    xfer += oprot->writeStructBegin("Calculator_works_pargs");
...
Calculator_works_result::~Calculator_works_result() throw() {
}


uint32_t Calculator_works_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Calculator_works_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

    uint32_t xfer = 0;

    xfer += oprot->writeStructBegin("Calculator_works_result");

    if (this->__isset.success) {
        xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_LIST, 0);
        {
            xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
            std::vector<Work> ::const_iterator _iter10;
...
Calculator_works_presult::~Calculator_works_presult() throw() {
}


uint32_t Calculator_works_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void CalculatorClient::works(std::vector<Work> & _return) {
    send_works();
    recv_works(_return);
}

void CalculatorClient::send_works() {
    int32_t cseqid = 0;
    oprot_->writeMessageBegin("works", ::apache::thrift::protocol::T_CALL, cseqid);

    Calculator_works_pargs args;
    args.write(oprot_);
...
void CalculatorClient::recv_works(std::vector<Work> & _return) {
    ...
    if (fname.compare("works") != 0) {
        iprot_->skip(::apache::thrift::protocol::T_STRUCT);
        iprot_->readMessageEnd();
        iprot_->getTransport()->readEnd();
    }
    Calculator_works_presult result;
    result.success = &_return;
    result.read(iprot_);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
    ...
    throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "works failed: unknown result");
}
...
void CalculatorProcessor::process_works(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext) {
    void* ctx = NULL;
    if (this->eventHandler_.get() != NULL) {
        ctx = this->eventHandler_->getContext("Calculator.works", callContext);
    }
    ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "Calculator.works");

    if (this->eventHandler_.get() != NULL) {
        this->eventHandler_->preRead(ctx, "Calculator.works");
    }

    Calculator_works_args args;
    args.read(iprot);
    iprot->readMessageEnd();
    uint32_t bytes = iprot->getTransport()->readEnd();

    if (this->eventHandler_.get() != NULL) {
        this->eventHandler_->postRead(ctx, "Calculator.works", bytes);
    }

    Calculator_works_result result;
    try {
        iface_->works(result.success);
        result.__isset.success = true;
    } catch (const std::exception& e) {
        if (this->eventHandler_.get() != NULL) {
            this->eventHandler_->handlerError(ctx, "Calculator.works");
        }

        ::apache::thrift::TApplicationException x(e.what());
        oprot->writeMessageBegin("works", ::apache::thrift::protocol::T_EXCEPTION, seqid);
        x.write(oprot);
        oprot->writeMessageEnd();
        oprot->getTransport()->writeEnd();
        oprot->getTransport()->flush();
    ...
    if (this->eventHandler_.get() != NULL) {
        this->eventHandler_->preWrite(ctx, "Calculator.works");
    }

    oprot->writeMessageBegin("works", ::apache::thrift::protocol::T_REPLY, seqid);
    result.write(oprot);
    oprot->writeMessageEnd();
    bytes = oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
    ...
    if (this->eventHandler_.get() != NULL) {
        this->eventHandler_->postWrite(ctx, "Calculator.works", bytes);
    }
}
...
void CalculatorConcurrentClient::works(std::vector<Work> & _return) {
    int32_t seqid = send_works();
    recv_works(_return, seqid);
}

int32_t CalculatorConcurrentClient::send_works() {
    int32_t cseqid = this->sync_.generateSeqId();
    ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
    oprot_->writeMessageBegin("works", ::apache::thrift::protocol::T_CALL, cseqid);
...
void CalculatorConcurrentClient::recv_works(std::vector<Work> & _return, const int32_t seqid) {
